...
public class ObstaclePROScript : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        GridSize = playerScript.gameManager.ObstacleGridSize;
    ...
    private void CreateCubesGrid(GameObject[,] grid, int size)
    {
        ...
        for (int i = 0; i < size; i++)
        {
            for (int j = 0; j < size; j++)
            {
                ...
                grid[j, i] = NewCube;
                // NewCube.GetComponent<CubeScript>().CubeColor = ObstacleColor;
    ...
    private void CreatePlayerShape(List<GameObject> ShapeList)
    {
        ...
        foreach (GameObject cube in ShapeList)
        {
            ...
            cube.GetComponent<CubeScript>().CubeColor = PlayerColor;
        ...
        playerScript.CanRayCast = true;  // Turn ON Raycast
    }
